...
export default function ComposeModal({ user, onSend, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none flex items-end justify-end p-4">
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 bg-muted/50 rounded-t-lg border-b border-border">
              ...
              <div className="flex items-center justify-between px-4 py-2">
                <div className="flex items-center gap-1">
                  <button
                    onClick={handleSend}
                    disabled={sending}
                    className="px-6 py-2 bg-primary text-primary-foreground rounded hover:bg-primary/90 transition text-sm font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {sending ? (
                      <>
